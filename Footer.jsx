...
export function MenuLinks({marketingSiteUrl}) {
    return (
       <ul className="d-flex flex-column flex-md-row flex-wrap list-unstyled gap-3 gap-md-4 menu-links align-items-center">
        <li className="mx-2"><Hyperlink destination={`${marketingSiteUrl}/about-us/`}>About Us</Hyperlink></li>
        <li className="mx-2"><Hyperlink destination={`${marketingSiteUrl}/terms-of-service/`}>Terms of Service</Hyperlink></li>
        <li className="mx-2"><Hyperlink destination={`${marketingSiteUrl}/privacy-policy/`}>Privacy Policy</Hyperlink></li>
        <li className="mx-2"><Hyperlink destination={`${marketingSiteUrl}/honor-code/`}>Honor Code</Hyperlink></li>
        <li className="mx-2"><Hyperlink destination="https://accessibility.mit.edu/">Accessibility</Hyperlink></li>
      </ul>
    );
  }
...
const image = (
    <Image src={imageUrl} style={{ maxHeight: '2rem', height: "33px", width: "121px" }} />
);
...
const config = {
    imageUrl: "https://courses-rc.xpro.mit.edu/static/xpro/images/logo.svg",
    destinationUrl: "https://rc.xpro.mit.edu/",
    ...
    centerLinks: [  // Will be used if the slot is not overridden
      {
        label: "First Column",
        links: [
          { label: "About Us", url: "https://rc.xpro.mit.edu/about-us/" },
          { label: "Terms of Service", url: "https://rc.xpro.mit.edu/terms-of-service/" },
          { label: "Privacy Policy", url: "https://rc.xpro.mit.edu/privacy-policy/" },
        ],
      },
      {
        label: "Second Column",
        links: [
            { label: "Honor Code", url: "https://rc.xpro.mit.edu/honor-code/" },
