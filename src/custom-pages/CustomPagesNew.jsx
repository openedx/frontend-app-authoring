          ...
          >
            <Layout.Element>
              <article>
                ...
                <ErrorAlert
                  hideHeading
                  isError={deletePageStatus === RequestStatus.FAILED}
                >
                  {intl.formatMessage(messages.errorAlertMessage, {
                    actionName: 'delete',
                  })}
                </ErrorAlert>
                <ErrorAlert
                  hideHeading
                  isError={addPageStatus === RequestStatus.FAILED}
                >
                  {intl.formatMessage(messages.errorAlertMessage, {
                    actionName: 'add',
                  })}
                ...
                <ErrorAlert
                  hideHeading
                  isError={savingStatus === RequestStatus.FAILED}
                >
                  {intl.formatMessage(messages.errorAlertMessage, {
                    actionName: 'save',
                  })}
                </ErrorAlert>
                <div className="small gray-700 mb-4 page-note">
                  <FormattedMessage {...messages.note} />
                </div>
                <DraggableList
                  itemList={orderedPages}
                  setState={setOrderedPages}
            ...
            <Layout.Element>
              <div className="help-sidebar">
                <div className="h4 help-sidebar-other-title">
                  <FormattedMessage {...messages.pageExplanationHeader} />
                </div>
                <div className="small gray-700 help-sidebar-about-descriptions">
...
CustomPagesNew.propTypes = {
  courseId: PropTypes.string.isRequired,
  // injected
  intl: intlShape.isRequired,
};

export default injectIntl(CustomPagesNew);
