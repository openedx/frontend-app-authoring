...
import { addModel, addModels, removeModel, updateModel, updateModels } from '../../generic/model-store';
import { getCustomPages, deleteCustomPage, addCustomPage, updateCustomPage, updateCustomPageOrder } from './api';
import {
  setPageIds,
...
export const updateSingleCustomPage =
  ({ blockId, metadata, setCurrentPage }) =>
  (dispatch) => {
    dispatch(updateSavingStatus({ status: RequestStatus.IN_PROGRESS }));
    try {
      dispatch(
