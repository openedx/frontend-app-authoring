...
describe('CardSection', () => {
  ...
  test('renders children when open', () => {
    render(
      <CardSection summary="summary" isCardCollapsibleOpen>
        <h1>Section Text</h1>
      </CardSection>,
    );
  ...
  test('renders summary when closed', () => {
    render(
      <CardSection summary="summary" isCardCollapsibleOpen={false}>
        <h1>Section Text</h1>
      </CardSection>,
    );
  ...
  test('renders nothing when closed and not summary', () => {
    const { container } = render(
      <CardSection isCardCollapsibleOpen={false}>
        <h1>Not showing text</h1>
      </CardSection>,
    );
