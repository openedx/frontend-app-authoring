...
const messages = defineMessages({
  ...
  ConfirmSwitchToAdvancedMessage: {
    id: 'authoring.problemeditor.settings.switchtoeditor.ConfirmSwitchToAdvancedMessage',
  ...
  ConfirmSwitchToMardownMessage: {
    id: 'authoring.problemeditor.settings.switchtoeditor.ConfirmSwitchToMardownMessage',
