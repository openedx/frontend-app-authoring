...
import { ProblemTypeKeys, ProblemTypes, getProblemTypes } from '@src/editors/data/constants/problem';
...
describe('Problem settings hooks', () => {
  ...
  describe('Type row hooks', () => {
    ...
    test('test typeRowHooks sets localized block title when formatMessage is provided', () => {
      ...
      jest.spyOn(require('@src/editors/data/constants/problem'), 'getProblemTypes').mockImplementation((fmt) => ({
