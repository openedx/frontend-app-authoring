...
const CardSection = ({ children, none, isCardCollapsibleOpen, summary }) => {
  ...
  return (
    <Card.Section className="pt-0">
      ...
      <Collapsible.Advanced open={isCardCollapsibleOpen}>
        <Collapsible.Body className="collapsible-body text-primary-500 x-small">{children}</Collapsible.Body>
      </Collapsible.Advanced>
    </Card.Section>
  );
};
