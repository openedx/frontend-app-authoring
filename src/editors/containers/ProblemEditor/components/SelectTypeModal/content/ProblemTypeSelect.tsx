...
const ProblemTypeSelect: React.FC<Props> = ({ selected, setSelected }) => {
  ...
  return (
    <Container style={{ width: '494px', height: '400px' }}>
      <SelectableBox.Set name="problem-type" columns={1} onChange={handleChange} type={settings.type} value={selected}>
