...
describe('EditConfirmationButtons', () => {
  ...
  it('renders two IconButtonWithTooltip buttons', () => {
    render(<EditConfirmationButtons updateTitle={jest.fn()} cancelEdit={jest.fn()} />);
  ...
  it('calls updateTitle when save button is clicked', () => {
    ...
    render(<EditConfirmationButtons updateTitle={updateTitleMock} cancelEdit={jest.fn()} />);
  ...
  it('calls cancelEdit when cancel button is clicked', () => {
    ...
    render(<EditConfirmationButtons updateTitle={jest.fn()} cancelEdit={cancelEditMock} />);
