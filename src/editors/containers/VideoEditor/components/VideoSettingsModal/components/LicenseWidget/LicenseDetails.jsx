...
import { ActionRow, CheckboxControl, Form, Icon, Stack } from '@openedx/paragon';
import { Attribution, Nd, Sa, Nc } from '@openedx/paragon/icons';
            ...
            <div className="border-primary-100 border-bottom pb-4">
              <Form.Group>
                <ActionRow>
                  ...
                  <ActionRow.Spacer />
                  <CheckboxControl disabled checked />
                </ActionRow>
              </Form.Group>
              <div>
