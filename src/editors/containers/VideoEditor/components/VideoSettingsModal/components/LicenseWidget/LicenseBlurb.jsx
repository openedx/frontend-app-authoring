...
const LicenseBlurb = ({ license, details }) => (
  <div className="d-flex flex-row align-items-center mt-2">
    ...
    {license === LicenseTypes.allRightsReserved ? (
      <Icon src={Copyright} className="mr-1" style={{ height: '18px', width: '18px' }} />
    ) : null}
    {license === LicenseTypes.creativeCommons ? (
      <Icon src={Cc} className="mr-1" style={{ height: '18px', width: '18px' }} />
    ) : null}
    {details.attribution ? (
      <Icon src={Attribution} className="mr-1 text-primary-300" style={{ height: '18px', width: '18px' }} />
    ) : null}
    ...
    {license === LicenseTypes.allRightsReserved ? (
      <div className="small mx-1.5">
        <FormattedMessage {...messages.allRightsReservedIconsLabel} />
      </div>
    ) : null}
    {license === LicenseTypes.creativeCommons ? (
      <div className="small mx-1.5">
        <FormattedMessage {...messages.creativeCommonsIconsLabel} />
      </div>
    ) : null}
  </div>
);
