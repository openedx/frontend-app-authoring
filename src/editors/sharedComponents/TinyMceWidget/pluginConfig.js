  ...
  return StrictDict({
    ...
    toolbar: toolbar
      ? mapToolbars([
          ...
          [buttons.align.left, buttons.align.center, buttons.align.right, buttons.align.justify],
          [buttons.bullist, buttons.numlist, buttons.outdent, buttons.indent],
    ...
    quickbarsInsertToolbar: toolbar
      ? false
      : mapToolbars([
    ...
    quickbarsSelectionToolbar: toolbar
      ? false
      : mapToolbars([
          [buttons.undo, buttons.redo],
          [buttons.formatSelect],
          [buttons.bold, buttons.italic, buttons.underline, buttons.foreColor],
          [buttons.align.justify, buttons.bullist, buttons.numlist],
