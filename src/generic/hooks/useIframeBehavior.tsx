...
export const useIframeBehavior = ({
  ...
  const [windowTopOffset, setWindowTopOffset] = useKeyedState<number | null>(
    iframeStateKeys.windowTopOffset,
    null,
  );
  ...
  const receiveMessage = useCallback(
    (event: MessageEvent) => {
      ...
      switch (type) {
        case iframeMessageTypes.openPlayground:
          openCanvas({
            type: CanvasContentType.PLAYGROUND,
            data: payload,
          });
          break;
