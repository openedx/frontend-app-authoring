 ...
 */
export const ResizableBox = ({ children, minWidth = MIN_WIDTH, maxWidth }: ResizableBoxProps) => {
  ...
  const onMouseMove = useCallback(
    (e: MouseEvent) => {
      ...
      const newWidth = Math.min(Math.max(startWidthRef.current - dx, minWidth), maxWidth || defaultMaxWidth);
      setWidth(newWidth);
    },
  ...
  return (
    <div className="resizable" ref={boxRef} style={{ width: `${width}px` }}>
