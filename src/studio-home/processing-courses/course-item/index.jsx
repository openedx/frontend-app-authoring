...
import { ActionRow, Card, Hyperlink, Button, Icon } from '@openedx/paragon';
import { Close as CloseIcon, Warning as WarningIcon, RotateRight as RotateRightIcon } from '@openedx/paragon/icons';
...
const CourseItem = ({ course }) => {
  ...
  const { displayName, org, number, run, isInProgress, isFailed, dismissLink } = course;
        ...
        <Card className="card-item">
          ...
          <Card.Section className="p-3.5 small text-gray-700 bg-light-200">
            {intl.formatMessage(messages.itemInProgressFooterText, {
              refresh: (
                <Hyperlink destination="/home">{intl.formatMessage(messages.itemInProgressFooterHyperlink)}</Hyperlink>
              ),
            })}
          </Card.Section>
        </Card>
