...
const LibrariesV2Tab: React.FC<Props> = () => {
  ...
  // WIP: Replace with actual logic to determine if there are pending migrations
  const hasPendingMigrations = true;

  return (
    <>
      <MigrateLegacyLibrariesAlert hasPendingMigrations={hasPendingMigrations} />
