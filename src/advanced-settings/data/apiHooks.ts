...
import { getCourseAdvancedSettings, getProctoringExamErrors, updateCourseAdvancedSettings } from './api';
...
const sortSettingsByDisplayName = (settings: Record<string, any>): Record<string, any> =>
  Object.fromEntries(Object.entries(settings).sort(([, v1], [, v2]) => v1.displayName.localeCompare(v2.displayName)));
