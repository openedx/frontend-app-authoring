...
import './index.scss';
import { getMyCoursesParams } from '../data/selectors';
...
const CoursesFilters = ({
  ...
  const handleMenuFilterItemSelected = (filterType) => {
    ...
    dispatch(updateMyCoursesCoursesCustomParams(filterParamsFormat));
    dispatch(fetchMyCoursesData(locationValue, false, { page: 1, ...customParams }, true));
  };
