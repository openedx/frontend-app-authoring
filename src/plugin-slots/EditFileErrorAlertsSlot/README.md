...
![Additional alert displayed in altets slot on files page](./screenshot_files_alert_added.png)

### Additional Alert on Videos Page

![Additional alert displayed in altets slot on videos page](./screenshot_videos_alert_added.png)
