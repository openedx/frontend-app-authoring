...
const ScheduleSidebar = ({ courseId, proctoredExamSettingsUrl }) => {
  ...
  return (
    <HelpSidebar courseId={courseId} proctoredExamSettingsUrl={proctoredExamSettingsUrl} showOtherSettings>
      <h4 className="help-sidebar-about-title">{intl.formatMessage(messages.scheduleSidebarTitle)}</h4>
      <p className="help-sidebar-about-descriptions">{intl.formatMessage(messages.scheduleSidebarAbout)}</p>
    </HelpSidebar>
  );
};
