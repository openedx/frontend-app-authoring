...
import { CourseOutline, OutlineSidebarProvider, OutlineSidebarPagesProvider } from './course-outline';
      ...
      <CourseAuthoringPage>
        <Routes>
          ...
          <Route
            path="videos"
            element={
              getConfig().ENABLE_VIDEO_UPLOAD_PAGE_LINK_IN_CONTENT_DROPDOWN === 'true' ? (
                <PageWrap>
                  <VideosPage />
                </PageWrap>
              ) : null
