...
const messages = defineMessages({
  ...
  modalComponentSupportTooltipFullySupported: {
    ...
    defaultMessage:
      'Fully supported tools and features are available for Open edX installations, ' +
  ...
  modalComponentSupportTooltipNotSupported: {
    ...
    defaultMessage:
      'Tools with no support are not maintained by the Open edX community, ' +
  ...
  modalComponentSupportTooltipProvisionallySupported: {
    ...
    defaultMessage:
      'Provisionally supported tools might lack the robustness of functionality ' +
