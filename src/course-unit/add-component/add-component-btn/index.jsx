...
const AddComponentButton = ({ type, displayName, onClick, beta }) => {
  const intl = useIntl();

  return (
    <Button variant="outline-primary" className="add-component-button flex-column rounded-sm" onClick={onClick}>
