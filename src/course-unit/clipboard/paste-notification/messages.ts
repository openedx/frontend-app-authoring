...
const messages = defineMessages({
  hasConflictingErrorsTitle: {
    ...
    description:
      'Title for a notification indicating that files need manual updates ' + 'due to a conflict in the clipboard.',
  },
  hasConflictingErrorsDescription: {
    ...
    description:
      'Description for the notification indicating which files need manual ' + 'updates due to a clipboard conflict.',
  },
  ...
  hasErrorsTitle: {
    ...
    description:
      'Title for a notification indicating that some errors occurred, likely ' + 'related to file conflicts.',
  },
  hasErrorsDescription: {
    ...
    description:
      'Description for the notification indicating which required files ' +
  ...
  hasNewFilesTitle: {
    ...
    description:
      'Title for a notification indicating that new files have been added to ' + 'the Files & Uploads section.',
  },
