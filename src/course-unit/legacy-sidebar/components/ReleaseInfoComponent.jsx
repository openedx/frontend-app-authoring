...
const ReleaseInfoComponent = () => {
  const intl = useIntl();
  const { releaseDate, releaseDateFrom } = useSelector(getCourseUnitData);
  ...
  if (releaseInfo.isScheduled) {
    return (
      <span className="course-unit-sidebar-date-and-with">
        <h6 className="course-unit-sidebar-date-timestamp m-0 d-inline">{releaseInfo.releaseDate}&nbsp;</h6>
