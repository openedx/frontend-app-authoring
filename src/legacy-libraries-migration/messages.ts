...
const messages = defineMessages({
  ...
  previouslyMigratedAlert: {
    ...
    defaultMessage:
      'Previously migrated library. Any problem bank links were already' +
  ...
  helpAndSupportFirstQuestionBody: {
    ...
    defaultMessage:
      'In the new Content Libraries experience, you can author sections,' +
  ...
  helpAndSupportSecondQuestionBody: {
    ...
    defaultMessage:
      'All legacy library content is supported in the new experience.' +
  ...
  helpAndSupportThirdQuestionBody: {
    ...
    defaultMessage:
      '<p>There are three steps to migrating legacy libraries:</p>' +
  ...
  migrationInProgress: {
    ...
    defaultMessage:
      '{count, plural, one {{count} legacy library is} other {{count} legacy libraries are}} being migrated.',
