...
const renderComponent = (props = {}) =>
  render(
    <IntlProvider locale="en">
      <EnrollmentTrackGroupsSection availableGroup={enrollmentTrackGroupsMock} {...props} />
    </IntlProvider>,
  );
...
describe('<EnrollmentTrackGroupsSection />', () => {
  it('renders component correctly', () => {
    ...
    expect(getAllByTestId('content-group-card')).toHaveLength(enrollmentTrackGroupsMock.groups.length);
  });
});
