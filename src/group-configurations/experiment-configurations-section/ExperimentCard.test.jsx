...
describe('<ExperimentCard />', () => {
  it('renders component correctly', () => {
    ...
    expect(
      getByText(commonMessages.titleId.defaultMessage.replace('{id}', experimentConfiguration.id)),
    ).toBeInTheDocument();
  ...
  it('renders usage with validation error message', async () => {
    ...
    expect(getByText(experimentConfigurationUpdated.usage[0].validation.text)).toBeInTheDocument();
  });
