...
export const experimentFormValidationSchema = (formatMessage) =>
  Yup.object().shape({
    id: Yup.number(),
    name: Yup.string().trim().required(formatMessage(messages.experimentConfigurationNameRequired)),
    description: Yup.string(),
    groups: Yup.array()
      .of(
        Yup.object().shape({
          id: Yup.number(),
          name: Yup.string().trim().required(formatMessage(messages.experimentConfigurationGroupsNameRequired)),
          version: Yup.number(),
