...
const messages = defineMessages({
  ...
  aboutDescription_1: {
    ...
    defaultMessage:
      'If you have cohorts enabled in your course, you can use content groups to create cohort-specific courseware. In other words, you can customize the content that particular cohorts see in your course.',
  ...
  aboutDescription_3: {
    ...
    defaultMessage:
      'Click {strongText} to add a new content group. To edit the name of a content group, hover over its box and click {strongText2}. You can delete a content group only if it is not in use by a unit. To delete a content group, hover over its box and click the delete icon.',
    description:
      'Third description for the content groups section in the sidebar. Mentions how to add, edit, and delete content groups.',
  },
  ...
  about_2_description_2: {
    ...
    defaultMessage:
      'Click {strongText} to add a new configuration. To edit a configuration, hover over its box and click {strongText2}. You can delete a group configuration only if it is not in use in an experiment. To delete a configuration, hover over its box and click the delete icon.',
    description:
      'Second description for the experiment group configurations section in the sidebar. Mentions how to add, edit, and delete group configurations.',
  },
  ...
  about_3_description_1: {
    ...
    defaultMessage:
      'Enrollment track groups allow you to offer different course content to learners in each enrollment track. Learners enrolled in each enrollment track in your course are automatically included in the corresponding enrollment track group.',
  ...
  about_3_description_2: {
    ...
    defaultMessage:
      'On unit pages in the course outline, you can restrict access to components to learners based on their enrollment track.',
  ...
  about_3_description_3: {
    ...
    defaultMessage:
      'You cannot edit enrollment track groups, but you can expand each group to view details of the course content that is designated for learners in the group.',
    description:
      'Third description for the enrollment track groups section in the sidebar. Mentions the limitations and options for managing enrollment track groups.',
  },
