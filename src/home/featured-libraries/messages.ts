...
const messages = defineMessages({
  allCoursesBtnText: {
    id: 'course-authoring.studio-home.courses.tab.all-courses.btn.text',
  ...
  addNewCourseBtnText: {
    id: 'course-authoring.studio-home.courses.tab.add-new-course.btn.text',
    defaultMessage: 'New course',
  },
  addNewLibraryBtnText: {
    id: 'course-authoring.studio-home.libraries.tab.add-new-library.btn.text',
  ...
  librariesV2TabBetaText: {
    ...
    defaultMessage:
      'Welcome to the new Beta Libraries experience! Libraries have been redesigned from the ground up,'
