...
import {
  ...
  blockStateFactory,
  libraryFactory,
} from '@src/library-authoring/common/specs/factories';
import LibraryAuthoringPageContainer from '../LibraryAuthoringPage';
import { LIBRARY_TYPES, LOADING_STATUS, STORE_NAMES } from '@src/library-authoring/common/data';
import {
  clearLibrary,
...
import { HTML_TYPE, PROBLEM_TYPE, VIDEO_TYPE } from '@src/library-authoring/common/specs/constants';
import {
