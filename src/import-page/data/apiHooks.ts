...
export const importQueryKeys = {
  ...
  importStatus: (courseId: string, fileName: string) => [...importQueryKeys.all, courseId, fileName],
};
 ...
 */
export const useImportStatus = (courseId: string, stopRefetch: boolean, fileName?: string) =>
