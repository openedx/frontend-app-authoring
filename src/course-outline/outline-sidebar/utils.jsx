...
const getFormattedSidebarMessages = (docsLinks, intl) => {
  ...
  return [
    ...
    },
    {
      ...
      descriptions: [intl.formatMessage(messages.section_2_descriptions_1)],
      link: {
    ...
    },
    {
      ...
      descriptions: [intl.formatMessage(messages.section_3_descriptions_1)],
      link: {
    ...
    },
    {
      ...
      descriptions: [
        ...
        intl.formatMessage(messages.section_4_descriptions_2, {
          hide: <strong>{intl.formatMessage(messages.section_4_descriptions_2_hide)}</strong>,
        }),
        intl.formatMessage(messages.section_4_descriptions_3, {
