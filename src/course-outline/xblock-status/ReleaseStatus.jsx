...
const ReleaseStatus = ({ isInstructorPaced, explanatoryMessage, releaseDate, releasedToStudents }) => {
  const intl = useIntl();

  const explanatoryMessageDiv = () => <span data-testid="explanatory-message-span">{explanatoryMessage}</span>;
