          ...
          >
            ...
            {actions.childAddable && (
              <>
                ...
                {enableCopyPasteUnits && showPasteUnit && sharedClipboardData?.content && (
                  <PasteComponent
                    className="mt-4"
                    text={intl.formatMessage(messages.pasteButton)}
                    clipboardData={{
                      sourceEditUrl: sharedClipboardData.sourceEditUrl,
                      content: {
                        displayName: sharedClipboardData.content.displayName,
                        blockTypeDisplay: sharedClipboardData.content.blockTypeDisplay,
                      },
                      sourceContextTitle: sharedClipboardData.sourceContextTitle,
                    }}
