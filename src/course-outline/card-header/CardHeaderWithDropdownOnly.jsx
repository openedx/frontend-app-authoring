...
const CardHeaderWithDropdownOnly = ({
  ...
  const isDisabledPublish =
    (status === ITEM_BADGE_STATUS.live || status === ITEM_BADGE_STATUS.publishedNotLive) &&
    !hasChanges;
...
CardHeaderWithDropdownOnly.defaultProps = {
...
CardHeaderWithDropdownOnly.propTypes = {
...
export default CardHeaderWithDropdownOnly;
