...
describe('<ContainerRow />', () => {
  ...
  test('renders with modified state', async () => {
    ...
    expect(
      await screen.findByText(messages.modifiedDiffBeforeMessage.defaultMessage.replace('{blockType}', 'subsection')),
    ).toBeInTheDocument();
  });
  ...
  test('renders with removed state', async () => {
    ...
    expect(
      await screen.findByText(messages.removedDiffAfterMessage.defaultMessage.replace('{blockType}', 'subsection')),
    ).toBeInTheDocument();
  });
  ...
  test('calls onClick when clicked', async () => {
    ...
    render(
      <ContainerRow title="Test title" containerType="subsection" side="Before" state="modified" onClick={onClick} />,
    );
  ...
  test('renders with originalName', async () => {
    ...
    expect(
      await screen.findByText(messages.renamedDiffBeforeMessage.defaultMessage.replace('{name}', 'Modified name')),
    ).toBeInTheDocument();
  });
  ...
  test('renders with local content update', async () => {
    ...
    expect(
      await screen.findByText(
        messages.locallyContentUpdatedBeforeMessage.defaultMessage.replace('{blockType}', 'html'),
      ),
    ).toBeInTheDocument();
  });
  ...
  test('renders with moved state', async () => {
    ...
    expect(
      await screen.findByText(messages.movedDiffAfterMessage.defaultMessage.replace('{blockType}', 'subsection')),
    ).toBeInTheDocument();
  });
  ...
  test('renders with added state', async () => {
    ...
    expect(
      await screen.findByText(messages.addedDiffAfterMessage.defaultMessage.replace('{blockType}', 'subsection')),
    ).toBeInTheDocument();
  });
});
