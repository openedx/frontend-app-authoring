...
import { Hyperlink, Icon, Row, Spinner } from '@openedx/paragon';
import { ErrorOutline } from '@openedx/paragon/icons';
import isEmpty from 'lodash/isEmpty';
import { RequestStatus } from '../../data/constants';
import messages from './messages';

const UsageMetricsMessage = ({ usagePathStatus, usageLocations, error }) => {
  const intl = useIntl();
  let usageMessage;
  if (usagePathStatus === RequestStatus.SUCCESSFUL) {
    ...
    usageMessage = (
      <Row className="m-0 pt-1">
        <Icon className="mr-1 text-danger-500" size="sm" src={ErrorOutline} />
