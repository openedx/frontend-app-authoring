export const getSidebarData = ({ messages, intl }) => [
  {
    ...
    paragraphs: [
      ...
      intl.formatMessage(messages.workingWithCertificatesSecondParagraph, {
        strongText: <strong>{intl.formatMessage(messages.workingWithCertificatesSecondParagraph_strong)}</strong>,
      }),
      intl.formatMessage(messages.workingWithCertificatesThirdParagraph, {
  ...
  },
  {
    ...
    paragraphs: [
      intl.formatMessage(messages.issuingCertificatesFirstParagraph, {
        strongText: <strong>{intl.formatMessage(messages.issuingCertificatesFirstParagraph_strong)}</strong>,
      }),
      intl.formatMessage(messages.issuingCertificatesSecondParagraph, {
